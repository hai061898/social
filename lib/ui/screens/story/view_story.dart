  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FutureBuilder<List<ListStory>>(
        future: storyRepositories.getStoryByUSer(widget.storyHome.uidStory),
                      ...
                      child: PageView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return CachedNetworkImage(
                              fit: BoxFit.cover,
                              imageUrl:
                                  UA.baseUrl + snapshot.data![index].media);
                        },
                      ),
                    ),
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: NetworkImage(
                                    UA.baseUrl + widget.storyHome.avatar),
                              ),
