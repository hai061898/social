...
import 'package:social/ui/screens/chat/chat_page.dart';
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: FutureBuilder<ResponseUserSearch>(
            future: userRepositories.getAnotherUserById(widget.idUser),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            fit: BoxFit.cover,
                            image:
                                NetworkImage(UA.baseUrl + listImages.first))),
                  ),
                );
              },
            )
            ...
            child: isPendingFollowers == 0
                ...
                : TextButton(
                    ...
                    child: const TextCustom(
                        text: 'Pending', fontSize: 20, color: Colors.black),
                    onPressed: () {},
                  )),
        Container(
          height: 43,
        ...
        children: [
          SizedBox(
              ...
              child: user.cover != ''
                  ? Image(
                      fit: BoxFit.cover,
                      image: NetworkImage(UA.baseUrl + user.cover))
                  : Container(
                      height: 170,
                      width: size.width,
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: CircleAvatar(
                    backgroundImage: NetworkImage(UA.baseUrl + user.image)),
              ),
            ),
          ),
          Positioned(
