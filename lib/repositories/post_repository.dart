...
import 'package:social/models/response_comments.dart';
import 'package:social/models/response_post.dart';
import 'package:social/models/response_post_by_user.dart';
import 'package:social/models/response_post_profile.dart';
import 'package:social/models/response_post_saved.dart';
...
class PostRepositories {
  Future<DefaultResponse> addNewPost(
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('${UA.urlApi}/post/create-new-post'))
  ...
  Future<List<Post>> getAllPostHome() async {
    ...
    final resp = await http.get(Uri.parse('${UA.urlApi}/post/get-all-posts'),
  ...
  Future<List<PostProfile>> getPostProfiles() async {
    ...
    final resp = await http.get(
        Uri.parse('${UA.urlApi}/post/get-post-by-idPerson'),
        headers: {'Accept': 'application/json', 'xxx-token': token!});
  ...
  Future<DefaultResponse> savePostByUser(String uidPost) async {
    ...
    final resp = await http.post(
        Uri.parse('${UA.urlApi}/post/save-post-by-user'),
        headers: {'Accept': 'application/json', 'xxx-token': token!},
  ...
  Future<List<ListSavedPost>> getListPostSavedByUser() async {
    ...
    final resp = await http.get(
        Uri.parse('${UA.urlApi}/post/get-list-saved-posts'),
        headers: {'Accept': 'application/json', 'xxx-token': token!});
  ...
  Future<List<Post>> getAllPostsForSearch() async {
    ...
    final resp = await http.get(
        Uri.parse('${UA.urlApi}/post/get-all-posts-for-search'),
        headers: {'Accept': 'application/json', 'xxx-token': token!});
  ...
  Future<DefaultResponse> likeOrUnlikePost(
    ...
    final resp = await http.post(
        Uri.parse('${UA.urlApi}/post/like-or-unlike-post'),
        headers: {'Accept': 'application/json', 'xxx-token': token!},
  ...
  Future<List<Comment>> getCommentsByUidPost(String uidPost) async {
    ...
    final resp = await http.get(
      Uri.parse('${UA.urlApi}/post/get-comments-by-idpost/' + uidPost),
      headers: {'Accept': 'application/json', 'xxx-token': token!},
    );
  ...
  Future<DefaultResponse> addNewComment(String uidPost, String comment) async {
    ...
    final resp = await http.post(Uri.parse('${UA.urlApi}/post/add-new-comment'),
        headers: {'Accept': 'application/json', 'xxx-token': token!},
  ...
  Future<DefaultResponse> likeOrUnlikeComment(String uidComment) async {
    ...
    final resp = await http.put(
        Uri.parse('${UA.urlApi}/post/like-or-unlike-comment'),
        headers: {'Accept': 'application/json', 'xxx-token': token!},
  ...
  Future<List<PostUser>> listPostByUser() async {
    ...
    final resp = await http.get(
        Uri.parse('${UA.urlApi}/post/get-all-post-by-user-id'),
        headers: {'Accept': 'application/json', 'xxx-token': token!});
