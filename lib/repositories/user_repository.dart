...
import 'package:social/models/response_user_search.dart';
...
class UserRepositories {
  ...
  Future<DefaultResponse> createdUser(
    ...
    final resp = await http.post(Uri.parse('${UA.urlApi}/user'), headers: {
  ...
  Future<ResponseUser> getUserById() async {
    ...
    final resp = await http.get(Uri.parse('${UA.urlApi}/user/get-User-By-Id'),
  ...
  Future<DefaultResponse> verifyEmail(String email, String code) async {
    final resp = await http.get(
        Uri.parse('${UA.urlApi}/user/verify-email/' + code + '/' + email),
  ...
  Future<DefaultResponse> updatePictureCover(String cover) async {
    ...
    var request = http.MultipartRequest(
        'PUT', Uri.parse('${UA.urlApi}/user/update-cover'))
      ..headers['Accept'] = 'application/json'
  ...
  Future<DefaultResponse> updatePictureProfile(String profile) async {
    ...
    var request = http.MultipartRequest(
        'PUT', Uri.parse('${UA.urlApi}/user/update-image-profile'))
      ..headers['Accept'] = 'application/json'
      ..headers['xxx-token'] = token!
  ...
  Future<DefaultResponse> updateProfile(
    ...
    final resp = await http
        .put(Uri.parse('${UA.urlApi}/user/update-data-profile'), headers: {
      'Accept': 'application/json',
      'xxx-token': token!
    }, body: {
      'user': user,
  ...
  Future<DefaultResponse> changePassword(
    ...
    final resp = await http.put(Uri.parse('${UA.urlApi}/user/change-password'),
        headers: {'Accept': 'application/json', 'xxx-token': token!},
  ...
  Future<DefaultResponse> changeAccountPrivacy() async {
    ...
    final resp = await http.put(
        Uri.parse('${UA.urlApi}/user/change-account-privacy'),
        headers: {'Accept': 'application/json', 'xxx-token': token!});
  ...
  void searchUsers(String username) async {
    ...
    debouncer.onValue = (value) async {
      ...
      final resp = await http.get(
          Uri.parse('${UA.urlApi}/user/get-search-user/' + username),
          headers: {'Accept': 'application/json', 'xxx-token': token!});
  ...
  Future<ResponseUserSearch> getAnotherUserById(String idUser) async {
    ...
    final resp = await http.get(
        Uri.parse('${UA.urlApi}/user/get-another-user-by-id/' + idUser),
        headers: {'Accept': 'application/json', 'xxx-token': token!});
  ...
  Future<DefaultResponse> addNewFollowing(String uidFriend) async {
    ...
    final resp = await http.post(Uri.parse('${UA.urlApi}/user/add-new-friend'),
        headers: {'Accept': 'application/json', 'xxx-token': token!},
  ...
  Future<DefaultResponse> acceptFollowerRequest(
    ...
    final resp = await http.post(
        Uri.parse('${UA.urlApi}/user/accept-follower-request'),
        headers: {'Accept': 'application/json', 'xxx-token': token!},
  ...
  Future<DefaultResponse> deleteFollowing(String uidUser) async {
    ...
    final resp = await http.delete(
      Uri.parse('${UA.urlApi}/user/delete-following/' + uidUser),
      headers: {'Accept': 'application/json', 'xxx-token': token!},
    );
  ...
  Future<List<Following>> getAllFollowing() async {
    ...
    final resp = await http.get(
      Uri.parse('${UA.urlApi}/user/get-all-following'),
      headers: {'Accept': 'application/json', 'xxx-token': token!},
    );
  ...
  Future<List<Follower>> getAllFollowers() async {
    ...
    final resp = await http.get(
      Uri.parse('${UA.urlApi}/user/get-all-followers'),
      headers: {'Accept': 'application/json', 'xxx-token': token!},
    );
  ...
  Future<DefaultResponse> deleteFollowers(String uidUser) async {
    ...
    final resp = await http.delete(
      Uri.parse('${UA.urlApi}/user/delete-followers/' + uidUser),
      headers: {'Accept': 'application/json', 'xxx-token': token!},
    );
